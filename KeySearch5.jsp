...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p align="center" class="style1">	<span class="style2">Searched Hotels Under the item</span> =&gt; <%=request.getParameter("Aname")%></p>

<table border=0 width="840" style="border-collapse: collapse" bordercolor="#CC3300" cellpadding="0" cellspacing="0" align="left">
<tr>
  <td bgcolor="#FF6600" width="91"><strong>Hotel Name </strong></td>

  <td bgcolor="#FF6600" width="104"><b>Area Code </b></td>
...
<%
      	...
      	String sp=request.getParameter("Aname");
...
<tr>
 ...
 <td bgcolor="#FFFFFF" width="500"><a href="GoogleMapView1.jsp?Ano=<%=s3%>">Google MAP View</a></td>
</tr>
